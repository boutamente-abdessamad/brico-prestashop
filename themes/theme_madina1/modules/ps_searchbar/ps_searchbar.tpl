...
<div id="_desktop_search_block" class="block-search  col-lg-8 col-md-8 col-sm-12"> 
	<div id="search_widget" class=" search_top" data-search-controller-url="{$search_controller_url}">
		<form method="get" action="{$search_controller_url}">
			...
			<input class="text_input" type="text" name="s" value="{$search_string}" placeholder="{l s='Enter your search key...' d='Shop.Theme.Catalog'}" aria-label="{l s='Search' d='Shop.Theme.Catalog'}">
			<button type="submit">
